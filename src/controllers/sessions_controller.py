...
async def create_session(
    ...
    try:
        created_session = await session_service.create_session(session_data,session)
...
async def update_session(
    ...
    updated_session = await session_service.update_session(session_id, session_update,session)
